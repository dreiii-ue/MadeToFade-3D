...
if ($payment_method == "" || mysqli_num_rows($active_payment) == 0) {
    die("Selected payment method is not available. Please go back to your cart and choose another payment method.");
}
